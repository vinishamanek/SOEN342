...
public class Driver {
    public static void main(String[] args) {
        ...
        // Keeping the below code for archival purposes
        // Organization organization = Organization.getInstance("Dunder Mifflin Paper
        // Company");
        ...
        // TimeSlot timeslot1 = new TimeSlot(DayOfWeek.MONDAY, LocalTime.of(9, 0),
        // LocalTime.of(10, 30));
        // TimeSlot timeslot2 = new TimeSlot(DayOfWeek.TUESDAY, LocalTime.of(11, 0),
        // LocalTime.of(12, 30));
        ...
        // organization);
        // users[1] = new Instructor("pam@concordia.ca", "password", organization,
        // Arrays.asList(montreal),
        // "Swimming");
